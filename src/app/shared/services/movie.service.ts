...
import { GenreResponse, MovieResponse, MovieSearchResponse } from '../../../shared/models/movie';
...
export class MovieService {
  ...
  getTopRatedMovies(page: number) {
    return this.http.get<MovieResponse>(`https://api.themoviedb.org/3/movie/top_rated?language=pt-BR&page=${page}&api_key=8edfd0871c45ff6fbffc33263bdd4fde`);
  }
